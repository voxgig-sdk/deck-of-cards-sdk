...
local DeckOfCardsSDK = {}
DeckOfCardsSDK.__index = DeckOfCardsSDK
...
DeckOfCardsSDK._make_feature = _make_feature


function DeckOfCardsSDK.new(options)
  local self = setmetatable({}, DeckOfCardsSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function DeckOfCardsSDK:options_map()
...
function DeckOfCardsSDK:get_utility()
  return Utility.copy(self._utility)
end


function DeckOfCardsSDK:get_root_ctx()
  return self._rootctx
end


function DeckOfCardsSDK:prepare(fetchargs)
...
function DeckOfCardsSDK:direct(fetchargs)
...
-- by passing it.
function DeckOfCardsSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function DeckOfCardsSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "DeckOfCardsSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function DeckOfCardsSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = DeckOfCardsSDK.new(sdkopts)
  sdk.mode = "test"
