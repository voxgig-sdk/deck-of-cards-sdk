...
local SDK_MODULE = "deck-of-cards_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["deck"] = { ["test01"] = { id = "test01" } }, ["draw"] = { ["test01"] = { id = "test01" } }, ["pile"] = { ["test01"] = { id = "test01" } }, ["pile_draw"] = { ["test01"] = { id = "test01" } }, ["pile_list"] = { ["test01"] = { id = "test01" } }, ["return"] = { ["test01"] = { id = "test01" } } } }'
