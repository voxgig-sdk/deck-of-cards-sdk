...
describe("DeckDirect", function()
  it("should direct-load-deck", function()
    local setup = deck_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-deck", setup.live and "live" or "unit")
...
function deck_direct_setup(mockres)
