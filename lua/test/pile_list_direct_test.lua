...
describe("PileListDirect", function()
  it("should direct-load-pile_list", function()
    local setup = pile_list_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-pile_list", setup.live and "live" or "unit")
...
function pile_list_direct_setup(mockres)
