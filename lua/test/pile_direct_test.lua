...
describe("PileDirect", function()
  it("should direct-load-pile", function()
    local setup = pile_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-pile", setup.live and "live" or "unit")
...
function pile_direct_setup(mockres)
