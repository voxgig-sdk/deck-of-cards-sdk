...
function runner.env_override(m)
  local live = runner.getenv("DECK_OF_CARDS_TEST_LIVE")
  local override = runner.getenv("DECK_OF_CARDS_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("DECK_OF_CARDS_TEST_EXPLAIN")
