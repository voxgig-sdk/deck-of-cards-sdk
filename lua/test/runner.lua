...
function runner.env_override(m)
  local live = runner.getenv("DECKOFCARDS_TEST_LIVE")
  local override = runner.getenv("DECKOFCARDS_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("DECKOFCARDS_TEST_EXPLAIN")
