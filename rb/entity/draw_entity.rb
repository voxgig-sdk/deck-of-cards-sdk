...
class DrawEntity
  ...
  #
  # @param reqmatch [DrawListMatch, Hash, nil] match filter (any subset of
  #   Draw fields); defaults to nil, treated as an empty match that lists all.
