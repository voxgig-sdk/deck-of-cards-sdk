...
class ReturnEntity
  ...
  # @return [Return, Hash] the current Return data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Return fields)
  def match_get
  ...
  #
  # @param reqmatch [ReturnLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Return.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Return, Hash] the loaded Return; raises DeckOfCardsError on failure
