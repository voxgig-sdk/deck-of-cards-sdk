...
class PileDrawEntity
  ...
  def make
    opts = @_entopts.dup
    PileDrawEntity.new(@_client, opts)
  end
  ...
  # @return [PileDraw, Hash] the current PileDraw data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of PileDraw fields)
  def match_get
  ...
  #
  # @param reqmatch [PileDrawListMatch, Hash, nil] match filter (any subset of
  #   PileDraw fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<PileDraw>, Array] the matching PileDraw items; raises DeckOfCardsError on failure
