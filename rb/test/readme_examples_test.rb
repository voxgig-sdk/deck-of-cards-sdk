...
#      offline in seeded test mode (DeckOfCardsSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "DeckOfCards_sdk.rb")
  SDK_CLASS = "DeckOfCardsSDK"
