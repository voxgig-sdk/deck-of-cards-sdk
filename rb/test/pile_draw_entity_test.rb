...
class PileDrawEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set DECK_OF_CARDS_TEST_PILE_DRAW_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def pile_draw_basic_setup(extra)
  ...
  entid_env_raw = ENV["DECK_OF_CARDS_TEST_PILE_DRAW_ENTID"]
