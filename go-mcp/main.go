// Command DeckOfCards-mcp is an MCP server exposing the DeckOfCards
// SDK as MCP tools.
//
// Two tools are registered:
//
//	DeckOfCards_list  — list records of an entity
//	DeckOfCards_load  — load a single record of an entity
//
