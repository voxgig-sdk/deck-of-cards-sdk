...
func registerSDKWords(r *eng.Registry, client *sdk.DeckOfCardsSDK) {
...
func runOp(client *sdk.DeckOfCardsSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
