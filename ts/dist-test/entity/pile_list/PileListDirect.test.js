...
(0, node_test_1.describe)('PileListDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-pile_list', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-pile_list', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["deck_id01", "pile_name01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['DECK_OF_CARDS_TEST_PILE_LIST_ENTID'];
...
//# sourceMappingURL=PileListDirect.test.js.map