...
(0, node_test_1.describe)('PileDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-pile', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-pile', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['DECK_OF_CARDS_TEST_PILE_ENTID'];
...
//# sourceMappingURL=PileDirect.test.js.map