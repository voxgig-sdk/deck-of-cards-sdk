...
(0, node_test_1.describe)('ReturnDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-return', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-return', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['DECK_OF_CARDS_TEST_RETURN_ENTID'];
...
//# sourceMappingURL=ReturnDirect.test.js.map