...
(0, node_test_1.describe)('ReturnEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/return/ReturnTestData.json');
    ...
    let idmap = transform(['return01', 'return02', 'return03', 'deck01', 'deck02', 'deck03', 'deck01', 'deck02', 'deck03', 'pile01', 'pile02', 'pile03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=ReturnEntity.test.js.map