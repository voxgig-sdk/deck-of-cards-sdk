...
(0, node_test_1.describe)('DrawEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'draw.' + op, live))
                return;
        }
        ...
        let draw_ref01_data = Object.values(setup.data.existing.draw)[0];
        // LIST
        const draw_ref01_ent = client.Draw();
        const draw_ref01_match = {};
        draw_ref01_match['deck_id'] = setup.idmap['deck01'];
        const draw_ref01_list = (await draw_ref01_ent.list(draw_ref01_match)).map((e) => e.data());
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/draw/DrawTestData.json');
    ...
    let idmap = transform(['draw01', 'draw02', 'draw03', 'deck01', 'deck02', 'deck03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=DrawEntity.test.js.map