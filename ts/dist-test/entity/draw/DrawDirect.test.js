...
(0, node_test_1.describe)('DrawDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-draw', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-draw', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["deck01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['DECK_OF_CARDS_TEST_DRAW_ENTID'];
...
//# sourceMappingURL=DrawDirect.test.js.map