...
(0, node_test_1.describe)('PileDrawDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.DeckOfCardsSDK({
    ...
    (0, node_test_1.test)('direct-list-pile_draw', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-pile_draw', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["deck01", "pile_name01"]))
            return;
...
function liveScenariosActive() { return false && process.env.DECK_OF_CARDS_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.DeckOfCardsSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['DECK_OF_CARDS_TEST_PILE_DRAW_ENTID'];
    ...
    const client = new __1.DeckOfCardsSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=PileDrawDirect.test.js.map