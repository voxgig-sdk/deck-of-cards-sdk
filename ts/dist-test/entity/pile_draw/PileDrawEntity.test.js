...
(0, node_test_1.describe)('PileDrawEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/pile_draw/PileDrawTestData.json');
    ...
    let idmap = transform(['pile_draw01', 'pile_draw02', 'pile_draw03', 'deck01', 'deck02', 'deck03', 'pile01', 'pile02', 'pile03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=PileDrawEntity.test.js.map