...
function envOverride(m) {
    if ('TRUE' === process.env.DECK_OF_CARDS_TEST_LIVE ||
        'TRUE' === process.env.DECK_OF_CARDS_TEST_OVERRIDE) {
    ...
    m.DECK_OF_CARDS_TEST_EXPLAIN = process.env.DECK_OF_CARDS_TEST_EXPLAIN || m.DECK_OF_CARDS_TEST_EXPLAIN;
    return m;
}
