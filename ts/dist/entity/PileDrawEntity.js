...
class PileDrawEntity extends DeckOfCardsEntityBase_1.DeckOfCardsEntityBase {
    constructor(client, entopts) {
        ...
        this.name = 'pile_draw';
        this.name_ = 'pile_draw';
        this.Name = 'PileDraw';
    }
    make() {
        return new PileDrawEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<PileDraw[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
}
exports.PileDrawEntity = PileDrawEntity;
//# sourceMappingURL=PileDrawEntity.js.map