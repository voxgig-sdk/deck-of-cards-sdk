...
// instead of `sdk.NewDeckOfCardsSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *DeckOfCardsSDK  { return NewDeckOfCardsSDK(nil) }
func Test() *DeckOfCardsSDK { return TestSDK(nil, nil) }
