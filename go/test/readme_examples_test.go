...
const testSeed = `map[string]any{"entity": map[string]any{"deck": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "draw": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "pile": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "pile_draw": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "pile_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "return": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
