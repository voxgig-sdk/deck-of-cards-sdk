...
func NewReturnEntity(client *core.DeckOfCardsSDK, entopts map[string]any) *ReturnEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ReturnEntity) GetName() string { return e.name }
...
func (e *ReturnEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ReturnEntity) Deleted() bool {
	return e.deleted
}


func (e *ReturnEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewReturnEntity(e.client, opts)
}

func (e *ReturnEntity) Data(args ...any) any {
...
func (e *ReturnEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *ReturnEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ReturnEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ReturnEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ReturnEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ReturnEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ReturnEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
