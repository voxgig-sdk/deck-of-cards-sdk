...
func NewPileDrawEntity(client *core.DeckOfCardsSDK, entopts map[string]any) *PileDrawEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PileDrawEntity) GetName() string { return e.name }
...
func (e *PileDrawEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PileDrawEntity) Deleted() bool {
	return e.deleted
}


func (e *PileDrawEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPileDrawEntity(e.client, opts)
}

func (e *PileDrawEntity) Data(args ...any) any {
...
func (e *PileDrawEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PileDraw; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PileDrawEntity) DataTyped(data ...PileDraw) PileDraw {
	if len(data) > 0 {
		return typedFrom[PileDraw](e.Data(asMap(data[0])))
	}
	return typedFrom[PileDraw](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PileDraw (all fields
// optional at the wire level).
func (e *PileDrawEntity) MatchTyped(match ...PileDraw) PileDraw {
	if len(match) > 0 {
		return typedFrom[PileDraw](e.Match(asMap(match[0])))
	}
	return typedFrom[PileDraw](e.Match())
}
...
func (e *PileDrawEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PileDrawEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *PileDrawEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PileDrawListMatch and returns []PileDraw. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PileDrawEntity) ListTyped(reqmatch PileDrawListMatch, ctrl map[string]any) ([]PileDraw, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[PileDraw](res), nil
}



func (e *PileDrawEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PileDrawEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PileDrawEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PileDrawEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
