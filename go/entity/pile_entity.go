...
func NewPileEntity(client *core.DeckOfCardsSDK, entopts map[string]any) *PileEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PileEntity) GetName() string { return e.name }
...
func (e *PileEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PileEntity) Deleted() bool {
	return e.deleted
}


func (e *PileEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPileEntity(e.client, opts)
}

func (e *PileEntity) Data(args ...any) any {
...
func (e *PileEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *PileEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PileEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *PileEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PileEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PileEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PileEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
