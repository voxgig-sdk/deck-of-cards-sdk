...
func NewDrawEntity(client *core.DeckOfCardsSDK, entopts map[string]any) *DrawEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DrawEntity) GetName() string { return e.name }
...
func (e *DrawEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DrawEntity) Deleted() bool {
	return e.deleted
}


func (e *DrawEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDrawEntity(e.client, opts)
}

func (e *DrawEntity) Data(args ...any) any {
...
func (e *DrawEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Draw; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DrawEntity) DataTyped(data ...Draw) Draw {
	if len(data) > 0 {
		return typedFrom[Draw](e.Data(asMap(data[0])))
	}
	return typedFrom[Draw](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Draw (all fields
// optional at the wire level).
func (e *DrawEntity) MatchTyped(match ...Draw) Draw {
	if len(match) > 0 {
		return typedFrom[Draw](e.Match(asMap(match[0])))
	}
	return typedFrom[Draw](e.Match())
}
...
func (e *DrawEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DrawEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *DrawEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DrawListMatch and returns []Draw. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *DrawEntity) ListTyped(reqmatch DrawListMatch, ctrl map[string]any) ([]Draw, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Draw](res), nil
}



func (e *DrawEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DrawEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DrawEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DrawEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
