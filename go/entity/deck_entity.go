...
func NewDeckEntity(client *core.DeckOfCardsSDK, entopts map[string]any) *DeckEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DeckEntity) GetName() string { return e.name }
...
func (e *DeckEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DeckEntity) Deleted() bool {
	return e.deleted
}


func (e *DeckEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDeckEntity(e.client, opts)
}

func (e *DeckEntity) Data(args ...any) any {
...
func (e *DeckEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Deck; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DeckEntity) DataTyped(data ...Deck) Deck {
	if len(data) > 0 {
		return typedFrom[Deck](e.Data(asMap(data[0])))
	}
	return typedFrom[Deck](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Deck (all fields
// optional at the wire level).
func (e *DeckEntity) MatchTyped(match ...Deck) Deck {
	if len(match) > 0 {
		return typedFrom[Deck](e.Match(asMap(match[0])))
	}
	return typedFrom[Deck](e.Match())
}
...
func (e *DeckEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DeckEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DeckLoadMatch and returns an Deck. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *DeckEntity) LoadTyped(reqmatch DeckLoadMatch, ctrl map[string]any) (Deck, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Deck{}, err
	}
	return typedFrom[Deck](res), nil
}



func (e *DeckEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *DeckEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DeckEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DeckEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DeckEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
