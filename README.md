...
An API for playing cards.

Learn more about Deck of Cards API at [deckofcardsapi.com](https://deckofcardsapi.com).
...
// Load a specific pile (returns a Pile)
...
// Load a specific pile
pile, err := client.Pile(nil).Load(
    map[string]any{"deck_id": "example_deck_id", "pile_name": "example_pile_name"}, nil,
)
if err != nil {
    panic(err)
}
