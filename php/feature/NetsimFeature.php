...
// DeckOfCards SDK netsim feature
...
class DeckOfCardsNetsimFeature extends DeckOfCardsBaseFeature
{
    ...
    private function _simulate(DeckOfCardsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(DeckOfCardsContext $ctx, array $applied): void
    {
        $client = $this->client;
