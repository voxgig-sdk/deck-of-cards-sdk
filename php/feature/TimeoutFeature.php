...
// DeckOfCards SDK timeout feature
...
class DeckOfCardsTimeoutFeature extends DeckOfCardsBaseFeature
{
    ...
    private function _with_timeout(DeckOfCardsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(DeckOfCardsContext $_ctx, float $ms): void
    {
        $client = $this->client;
