...
class DeckOfCardsProxyFeature extends DeckOfCardsBaseFeature
{
    ...
    public function init(DeckOfCardsContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (DeckOfCardsContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
