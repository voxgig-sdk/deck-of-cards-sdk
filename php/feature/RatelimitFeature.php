...
// DeckOfCards SDK ratelimit feature
...
class DeckOfCardsRatelimitFeature extends DeckOfCardsBaseFeature
{
    ...
    private function _acquire(DeckOfCardsContext $ctx): void
    {
    ...
    private function _track(DeckOfCardsContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
