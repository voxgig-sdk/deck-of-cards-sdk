...
// DeckOfCards SDK telemetry feature
...
class DeckOfCardsTelemetryFeature extends DeckOfCardsBaseFeature
{
    ...
    private function _close(DeckOfCardsContext $ctx, bool $ok): void
    {
