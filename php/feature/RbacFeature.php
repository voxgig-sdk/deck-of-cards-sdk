...
class DeckOfCardsRbacFeature extends DeckOfCardsBaseFeature
{
    ...
    private function _required(DeckOfCardsContext $ctx): ?string
    {
    ...
    private function _reject(DeckOfCardsContext $ctx, string $required): void
    {
    ...
    private function _track(DeckOfCardsContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
