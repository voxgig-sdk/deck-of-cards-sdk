...
// DeckOfCards SDK utility: fetcher

class DeckOfCardsFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; DeckOfCardsSDK/1.0)';
    ...
    public static function call(DeckOfCardsContext $ctx, string $fullurl, array $fetchdef): array
    {
