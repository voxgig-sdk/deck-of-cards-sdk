...
// DeckOfCards SDK utility: graphql
//
...
class DeckOfCardsGraphql
{
    ...
    // equivalent.
    public static function body(DeckOfCardsContext $ctx): mixed
    {
    ...
    public static function errors(DeckOfCardsContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
