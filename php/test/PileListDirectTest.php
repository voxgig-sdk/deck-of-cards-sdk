...
class PileListDirectTest extends TestCase
{
    public function test_direct_load_pile_list(): void
    {
        $setup = pile_list_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-pile_list", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
