...
class PileDirectTest extends TestCase
{
    public function test_direct_load_pile(): void
    {
        $setup = pile_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-pile", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
