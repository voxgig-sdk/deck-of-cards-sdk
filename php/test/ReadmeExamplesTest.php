...
// DeckOfCards SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (DeckOfCardsSDK::test)
...
{
    private const SDK_CLASS = 'DeckOfCardsSDK';
    ...
    private const SDK_BASE = 'deckofcards_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../deckofcards_sdk.php';
