...
class DrawEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set DECKOFCARDS_TEST_DRAW_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function draw_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("DECKOFCARDS_TEST_DRAW_ENTID");
