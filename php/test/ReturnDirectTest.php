...
class ReturnDirectTest extends TestCase
{
    public function test_direct_load_return(): void
    {
        $setup = return_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-return", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
