...
class DeckDirectTest extends TestCase
{
    public function test_direct_load_deck(): void
    {
        $setup = deck_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-deck", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
