...
class DrawEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DrawEntity($this->_client, $opts);
    }

    /**
     * @param Draw|array $args Draw data (assoc-array) to store.
     */
    ...
    /**
     * @return Draw|array The current Draw data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Draw fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Draw fields).
     */
     ...
     *
     * @param DrawListMatch|array|null $reqmatch Match filter (any subset
     *   of Draw fields) as an assoc-array; DrawListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Draw[]|array A list of Draw items as assoc-arrays at
