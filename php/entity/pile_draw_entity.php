...
// DeckOfCards SDK PileDraw entity
...
class PileDrawEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PileDrawEntity($this->_client, $opts);
    }

    /**
     * @param PileDraw|array $args PileDraw data (assoc-array) to store.
     */
    ...
    /**
     * @return PileDraw|array The current PileDraw data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PileDraw fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PileDraw fields).
     */
    ...
    /**
     * List PileDraw items matching the given filter.
     *
     * @param PileDrawListMatch|array|null $reqmatch Match filter (any subset
     *   of PileDraw fields) as an assoc-array; PileDrawListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PileDraw[]|array A list of PileDraw items as assoc-arrays at
     *   the SDK boundary; throws DeckOfCardsError on failure (item-5 convention).
     */
