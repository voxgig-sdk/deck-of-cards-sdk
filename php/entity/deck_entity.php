...
class DeckEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DeckEntity($this->_client, $opts);
    }

    /**
     * @param Deck|array $args Deck data (assoc-array) to store.
     */
    ...
    /**
     * @return Deck|array The current Deck data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Deck fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Deck fields).
     */
     ...
     * Load a single Deck.
     *
     * @param DeckLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DeckLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Deck|array The loaded Deck as an assoc-array at the
