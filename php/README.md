...
The PHP SDK for the DeckOfCards API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Deck(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->DeckOfCards(null)->load(
    ["id" => "test01"], null
);
