# DeckOfCards SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions DeckOfCardsSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both DeckOfCardsSDK(...) and DeckOfCardsSDK.test(...) become
#      DeckOfCardsSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "deckofcards_sdk"
_SDK_CLASS = "DeckOfCardsSDK"
