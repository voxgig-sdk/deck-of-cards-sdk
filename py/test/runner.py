...
class DeckOfCardsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = DeckOfCardsTestRunner.getenv("DECKOFCARDS_TEST_LIVE")
        override = DeckOfCardsTestRunner.getenv("DECKOFCARDS_TEST_OVERRIDE")
        ...
        explain = DeckOfCardsTestRunner.getenv("DECKOFCARDS_TEST_EXPLAIN")
