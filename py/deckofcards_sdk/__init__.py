...
from deckofcards_sdk.utility import register

# Load features
from deckofcards_sdk.feature.base_feature import DeckOfCardsBaseFeature
from deckofcards_sdk.features import _has_feature, _make_feature
...
class DeckOfCardsSDK:
    ...
    def get_utility(self):
        return DeckOfCardsUtility.copy(self._utility)
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "DeckOfCardsSDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("DeckOfCardsSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def PileDraw(self, data=None) -> "PileDrawEntity":
        ...
        from deckofcards_sdk.entity.pile_draw_entity import PileDrawEntity
    ...
    def PileList(self, data=None) -> "PileListEntity":
        ...
        from deckofcards_sdk.entity.pile_list_entity import PileListEntity
    ...
    def Return(self, data=None) -> "ReturnEntity":
        ...
        from deckofcards_sdk.entity.return_entity import ReturnEntity
