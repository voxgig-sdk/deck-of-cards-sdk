...
from projectname_sdk import DeckOfCardsSDK
from projectname_sdk.core.spec import DeckOfCardsSpec
from projectname_sdk.core.result import DeckOfCardsResult
from projectname_sdk.core.response import DeckOfCardsResponse
from projectname_sdk.core.operation import DeckOfCardsOperation
from projectname_sdk.core.error import DeckOfCardsError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import DeckOfCardsBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return DeckOfCardsError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = DeckOfCardsSDK.test(None, None)
        ...
        class TestInitFeature(DeckOfCardsBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(DeckOfCardsBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = DeckOfCardsSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = DeckOfCardsSDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = DeckOfCardsOperation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = DeckOfCardsSDK.test(None, setup_opts)
