...
class DeckOfCardsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = DeckOfCardsTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = DeckOfCardsTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = DeckOfCardsTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
