...
class DeckOfCardsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = DeckOfCardsTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = DeckOfCardsTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = DeckOfCardsTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
