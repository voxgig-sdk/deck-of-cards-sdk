# DeckOfCards SDK utility: make_error
...
def make_error_util(ctx, err):
    ...
    errmsg = ""
    if isinstance(err, DeckOfCardsError):
        errmsg = err.msg
    ...
    msg = "DeckOfCardsSDK: " + opname + ": " + errmsg
    ...
    sdk_err = DeckOfCardsError("", msg, ctx)
