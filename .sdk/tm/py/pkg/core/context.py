...
from projectname_sdk.core.control import DeckOfCardsControl
...
class DeckOfCardsContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, DeckOfCardsSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, DeckOfCardsResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, DeckOfCardsResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return DeckOfCardsError(code, msg, self)
