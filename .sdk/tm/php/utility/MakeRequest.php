...
// DeckOfCards SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class DeckOfCardsMakeRequest
{
    public static function call(DeckOfCardsContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new DeckOfCardsResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new DeckOfCardsResponse($fetched);
        } else {
