...
// DeckOfCards SDK clienttrack feature
...
class DeckOfCardsClienttrackFeature extends DeckOfCardsBaseFeature
{
    ...
    public function PostConstruct(DeckOfCardsContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'DeckOfCards-SDK';
