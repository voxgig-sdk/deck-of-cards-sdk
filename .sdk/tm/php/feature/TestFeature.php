...
// DeckOfCards SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class DeckOfCardsTestFeature extends DeckOfCardsBaseFeature
{
    ...
    public function init(DeckOfCardsContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (DeckOfCardsContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = DeckOfCardsParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (DeckOfCardsContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(DeckOfCardsContext $ctx, $op, $args): array
    {
