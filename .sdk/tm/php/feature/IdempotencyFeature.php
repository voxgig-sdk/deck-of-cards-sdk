...
// DeckOfCards SDK idempotency feature
...
class DeckOfCardsIdempotencyFeature extends DeckOfCardsBaseFeature
{
    ...
    private function _mutating(DeckOfCardsContext $ctx): bool
    {
