...
// DeckOfCards SDK metrics feature
...
class DeckOfCardsMetricsFeature extends DeckOfCardsBaseFeature
{
    ...
    private function _record(DeckOfCardsContext $ctx, bool $ok): void
    {
