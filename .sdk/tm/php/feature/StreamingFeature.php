...
// DeckOfCards SDK streaming feature
...
class DeckOfCardsStreamingFeature extends DeckOfCardsBaseFeature
{
    ...
    private function _iterate(DeckOfCardsResult $result): \Generator
    {
    ...
    private function _streamable(DeckOfCardsContext $ctx): bool
    {
