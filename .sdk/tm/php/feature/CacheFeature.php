...
class DeckOfCardsCacheFeature extends DeckOfCardsBaseFeature
{
    ...
    private function _through(DeckOfCardsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
