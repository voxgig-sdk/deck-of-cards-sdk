...
{
    private static function utility(): DeckOfCardsUtility
    {
        return new DeckOfCardsUtility();
    }
    ...
    private static function ctx(array $over = []): DeckOfCardsContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new DeckOfCardsContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new DeckOfCardsOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof DeckOfCardsError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new DeckOfCardsOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = DeckOfCardsMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new DeckOfCardsOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = DeckOfCardsMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new DeckOfCardsOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = DeckOfCardsMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new DeckOfCardsSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = DeckOfCardsMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new DeckOfCardsResponse([]),
            'result' => new DeckOfCardsResult([]),
        ]);
        [, $err] = DeckOfCardsMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new DeckOfCardsSpec([]),
            'response' => null,
            'result' => new DeckOfCardsResult([]),
        ]);
        [, $err] = DeckOfCardsMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new DeckOfCardsSpec(['step' => 's']),
            'response' => new DeckOfCardsResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new DeckOfCardsResult([]),
        ]);
        [, $err] = DeckOfCardsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new DeckOfCardsSpec(['step' => 's']),
            'response' => new DeckOfCardsResponse(self::resp(200, ['v' => 1])),
            'result' => new DeckOfCardsResult([]),
        ]);
        [, $err] = DeckOfCardsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new DeckOfCardsSpec(['step' => 's']),
            'response' => new DeckOfCardsResponse(self::resp(200, ['v' => 2])),
            'result' => new DeckOfCardsResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        DeckOfCardsMakeResponse::call($ctx);
    ...
    {
        $preset = new DeckOfCardsResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new DeckOfCardsSpec([]),
            'response' => new DeckOfCardsResponse([]),
            'result' => new DeckOfCardsResult([]),
        ...
        [$got, $err] = DeckOfCardsMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new DeckOfCardsResult([])]);
        [, $err] = DeckOfCardsMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new DeckOfCardsSpec([]), 'result' => null]);
        [, $err] = DeckOfCardsMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new DeckOfCardsSpec(['step' => 's']),
            'result' => new DeckOfCardsResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new DeckOfCardsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = DeckOfCardsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new DeckOfCardsSpec(['step' => 's']),
            'result' => new DeckOfCardsResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new DeckOfCardsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = DeckOfCardsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new DeckOfCardsResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new DeckOfCardsSpec([]),
            'result' => new DeckOfCardsResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = DeckOfCardsMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = DeckOfCardsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new DeckOfCardsError('boom', 'boom');
        $utility->fetcher = function (DeckOfCardsContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new DeckOfCardsSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = DeckOfCardsMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (DeckOfCardsContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = DeckOfCardsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(DeckOfCardsResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        DeckOfCardsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (DeckOfCardsContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new DeckOfCardsSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = DeckOfCardsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new DeckOfCardsResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new DeckOfCardsSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = DeckOfCardsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = DeckOfCardsMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = DeckOfCardsMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new DeckOfCardsResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, DeckOfCardsDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new DeckOfCardsResult(['ok' => false])]);
        $this->expectException(DeckOfCardsError::class);
        DeckOfCardsDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new DeckOfCardsResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', DeckOfCardsMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        DeckOfCardsMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new DeckOfCardsBaseFeature();
        $b = new DeckOfCardsBaseFeature();
        DeckOfCardsFeatureAdd::call($ctx, $a);
        DeckOfCardsFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): DeckOfCardsBaseFeature
    {
        $f = new DeckOfCardsBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        DeckOfCardsFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): DeckOfCardsContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new DeckOfCardsSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = DeckOfCardsPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        DeckOfCardsPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new DeckOfCardsResponse(['headers' => null]),
            'result' => new DeckOfCardsResult([]),
        ]);
        DeckOfCardsResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        DeckOfCardsResultBody::call($ctx);
