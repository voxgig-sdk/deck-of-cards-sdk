...
// DeckOfCards SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = DeckOfCardsOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(DeckOfCardsOmni::structfix($now, Struct::undef()))
                        !== json_encode(DeckOfCardsOmni::structfix($val, Struct::undef()))) {
