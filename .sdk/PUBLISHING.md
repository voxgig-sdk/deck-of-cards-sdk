...
|---|---|---|
| `ts/` | @voxgig-sdk/deck-of-cards-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/deck-of-cards-sdk \
      --repository voxgig-sdk/deck-of-cards-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/deck-of-cards-sdk` shows it, and
`npm trust revoke @voxgig-sdk/deck-of-cards-sdk --id=<id>` removes it.
